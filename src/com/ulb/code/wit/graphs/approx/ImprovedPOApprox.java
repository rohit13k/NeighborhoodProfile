...
public class ImprovedPOApprox {
	...
	public ImprovedPOApprox(NodeApprox targetNode, int sourceNode,
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof ImprovedPOApprox))
			return false;
		if (obj == this)
			return true;
		else {
			ImprovedPOApprox pe = (ImprovedPOApprox) obj;
